...
/*
 * Set: 데이터 중복허용 안됨, 순서를 유지하지 않는 집합
 * List: 데이터 중복허용 됨, 순서 유지
...
public class ExHashSet_10 {
	...
	public static void main(String[] args) {
		...
		//Set에 String 데이타를 담겠다-Set은 인터페이스이므로 객체생성이 안된다
		//추가.. 배열에 비해 가변적
		...
		System.out.println("데이터 개수: "+set1.size()); //collection에서는 lenth가 아니라 size이다
