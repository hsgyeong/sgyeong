...
public class VectorBoard_02 {
	...
	List <Board> list=new Vector<Board>();  //List는 인터페이스. 추상메서드를 모아놓음
	//클래스 타입으로 지정했으므로 데이터를 꺼내고 받을떄고 클래스여야 함
	...
	public void writeBoard()
	{
		...
		for(int i=0;i<list.size();i++)  //컬렉션에서는 무조건 list.size   (배열에서는 length)
		{
