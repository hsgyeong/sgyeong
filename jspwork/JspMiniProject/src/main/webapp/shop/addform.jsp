	...
	<div class="inputform" style="width: 500px;">
		<form action="shop/addaction.jsp" method="post"
			...
			<table class="table table-bordered">
				...
				<tr>
					<td style="width: 150px;" class="table-success"><b>카테고리</b><br>
				...
				<tr>
					<td style="width: 150px;" class="table-success"><b>상품이미지</b></td>
					<td><input type="file" name="photo" class="form-control"
						required="required" style="width: 400px;"></td>
				</tr>
				<tr>
					<td style="width: 150px;" class="table-success"><b>상품가격</b></td>
				...
				required="required" style="width:300px;" value="<%=day %>">
				</td>
				</tr>
				<tr>
