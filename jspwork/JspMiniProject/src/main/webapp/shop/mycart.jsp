...
%>
<body>
<h4 class="alert alert-success"><%=name %>님의 장바구니 목록</h4>
...
for(int i=0;i<list.size();i++)
{
	...
	%>
	<h4><%=nf.format(price) %>
	<i class="bi bi-trash3 del" idx=<%=map.get("idx") %>></i></h4>
	</td>
	</tr>
<%}
%>
...
<span style="font-size:1.3em;" float: right;>
총 주문금액: <b style="color:green;"><%=nf.format(allmoney) %>원</span>
</td>
</tr>
</table>
