...
<body>
	<div class="container mt-3">
		...
		<div class="tab-content">
			<div id="tabs-1" class="container tab-pane fade">
				<br>
				<p>
           ...
           for(ShopDto dto:list)
           {
              ...
              %>
						<td><a shopnum=<%=dto.getShopnum() %>
							style="cursor: pointer;" class="godetail"><img
								src="shopsave/<%=photo%>" class="photo"> <br> <%=dto.getSangpum() %><br></a>
							<b style="color: red; font-size: 1.2em;"><%=sale %>%</b> <span
							style="float: right;">
           ...
           %>
			...
			<div id="tabs-2" class="container tab-pane fade">
				<br>
				<p>
				<table class="table table-bordered" style="width: 700px;">
					<caption align="top">
          ...
          // NumberFormat nf=NumberFormat.getCurrencyInstance();
           ...
           for(ShopDto dto:list)
           {
			...
			<div id="tabs-3" class="container tab-pane fade">
				<br>
				<p>
				<table class="table table-bordered" style="width: 700px;">
					<caption align="top">
          ...
          // NumberFormat nf=NumberFormat.getCurrencyInstance();
           ...
           for(ShopDto dto:list)
           {
			...
			<div id="tabs-4" class="container tab-pane fade">
				<br>
				<p>
				<table class="table table-bordered" style="width: 700px;">
					<caption align="top">
          ...
          // NumberFormat nf=NumberFormat.getCurrencyInstance();
           ...
           for(ShopDto dto:list)
           {
			...
			<div id="tabs-5" class="container tab-pane fade">
				<br>
				<p>
				<table class="table table-bordered" style="width: 700px;">
					<caption align="top">
          ...
          // NumberFormat nf=NumberFormat.getCurrencyInstance();
           ...
           for(ShopDto dto:list)
           {
			...
			<div id="tabs-6" class="container tab-pane fade">
				<br>
				<p>
				<table class="table table-bordered" style="width: 700px;">
					<caption align="top">
