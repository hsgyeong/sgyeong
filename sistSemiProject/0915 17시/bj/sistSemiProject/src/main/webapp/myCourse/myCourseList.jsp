...
<caption align="top"><b>총 <%=totalCount %>건</b></caption>
	...
	<tr class="tourList" style="height:200px">
		<td style="width:200px;"><img src="<%=root%>/jeju/<%=tourSpotDto.getPhoto() %>" id="tourImg" style="width:150px"></td>
		<td style="width:700px;"><b id="tourName"><%=tourSpotDto.getName()%></b><br><br><p id="tourIntro"><%=tourSpotDto.getIntro() %></p>
