...
<div class="modal" id="ModalUpdate">
  <div class="modal-dialog modal-sm">
   ...
   <div class="modal-body">
      ...
      <input type="text" class="form-control" name="name" id="name" placeholder="회원명" value="${dto.name }"><br>
      <input type="text" class="form-control" name="email" id="email" placeholder="이메일" value="${dto.email }"><br>
      <input type="text" class="form-control" name="hp" id="hp" placeholder="연락처" value="${dto.hp }"><br>
      <input type="text" class="form-control" name="addr" id="addr" placeholder="주소" value="${dto.addr }"><br>
   </div>

      <!-- Modal footer -->
      <div class="modal-footer">
         <button type="button" class="btn btn-primary" id="btnupdate" data-bs-dismiss="modal" num=${dto.num }>수정</button>
