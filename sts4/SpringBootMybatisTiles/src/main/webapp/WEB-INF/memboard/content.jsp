			...
			<td>
				...
				<c:if test="${dto.uploadfile!='no' }">
					<span style="float:right;">
						<i class="bi bi-cloud-download" style="cursor:pointer;"></i>
						&nbsp;<a href="download?clip=${dto.uploadfile }"><b>${dto.uploadfile }</b></a>
					</span>
				</c:if>
			</td>
		</tr>
			...
			<td>
				<div class="d-inline-flex">
					<c:if test="${bupload==true }">
						<img alt="" src="../savefile/${dto.uploadfile }" style="width: 250px; height:250px;	margin-top: 120px;">
						&nbsp;&nbsp;&nbsp;&nbsp;
					</c:if>	
					<br><br>
